    ...
    try:
        ...
        rows = [
            ...
            ("🌉 New bridge here", "Today's handoff note for this list",
             f"xact:bridge_proj:{pid}", "bridge new handoff note claude", itype == "list"),
            ...
            ("🧾 Add log entry",  "Timestamped line · newest on top",
             ...
             _is_person_card),
            ("💬 Add fact",       "Conversation starter onto the card",
             f"xact:person_fact:{pid}:{tid}", "fact starter person people",
             _is_person_card),
            ("📇 Edit card",      "Birthday · phone · mail · instagram",
             f"xact:crmbrowse:ctx:person:{tid}:edit",
             "edit card fields person people contact", _is_person_card),
            ...
            ("🦅 Browse photos",   "Folders · counts · thumbnail grid",
             f"xact:crmbrowse:ctx:lbeagle:{tid}:hub",
             "browse photos grid folders images eagle",
             _is_logbook),
