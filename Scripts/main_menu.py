...
def build_items():
    return [
        ...
        alfred.item(
            ...
            arg="view",
            mods={
                "shift":     {"arg": "view_today"},
                "cmd":       {"arg": "view_tomorrow"},
                "alt":       {"arg": "view_7"},
                "ctrl":      {"arg": "view_inbox"},
                "cmd+shift": {"arg": "open:ticktick://v1/show?smartlist=today"},
                "cmd+alt":   {"arg": "open:ticktick://v1/show?smartlist=tomorrow"},
                "ctrl+alt":  {"arg": "open:ticktick://v1/show?smartlist=next_7_days", "subtitle": "Open 7 Days"},
                "ctrl+shift":{"arg": "open:ticktick:///webapp/#p/inbox/tasks"},
            },
        ),
        alfred.item(
            uid="filters",
