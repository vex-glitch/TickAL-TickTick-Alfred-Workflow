...
- Optional: PyObjC for the floating focus bar (`/opt/homebrew/bin/pip3 install --break-system-packages pyobjc` - the workflow's own Python; variants in [docs/30-setup.md](docs/30-setup.md)) - focus works without it
