...
| `/tmp/tickal_focus.json`, `/tmp/tickal_pomo.json`, `/tmp/tickal_focus_bar.json`, `/tmp/tickal_stage.txt` | Focus/pomodoro session and staging state; safe to delete when no session is running |
| `/tmp/tickal_buffer.txt` | The 🅿️ buffer queue |
